...
% profile.bart_pics_cmd       = 'pics -R W:7:0:0.01 -i 20 -S -d5';
profile.bart_pics_cmd       = 'pics -R T:2048:0:0.01 -i 40 -S -d5';
...
% profile.Cardiac_RetroPhases             = 1; % for relative binning
...
profile.respSG = 1; % perform respiratory self-gating, yes or no, must be yes for 4D
profile.respPhases = 8; % number of resp phases to recon
