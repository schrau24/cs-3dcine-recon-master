...
profile.name            = 'WRITE_FILENAME_HERE';
profile.data_dir        = 'COPY_FOLDER_LOCATION';
profile.data_target     = 'COPY_TARGET_NAME_HERE';
profile.data_senseref   = 'COPY_SENSEREF_NAME_HERE';
profile.data_coilsurvey = 'COPY_COILSURVEY_NAME_HERE';

%% % OPTIONAL PARAMETERS

%% define export [ 1:yes, 0:no]
profile.exp_mask        = 0;
profile.exp_parrec      = 0;
profile.exp_nii         = 0;
profile.exp_dcm         = 0;
profile.exp_sense       = 0;
...
profile.bart_pics_cmd       = 'pics -R W:7:0:0.01 -R T:1024:0:0.01 -i 50 -S -d5';
...
%% % CARDIAC PARAMETER
profile.card_RetroHoleInterpolationCenter = 'Yes'; % 'Yes', 'No'
profile.Cardiac_RetroHoleInterpolation  = 'Average'; % 'No', 'Nearest', 'Average', 'Linear', 'Cubic'  
...
profile.Cardiac_RetroPhases             = 24; % for relative binning
...
profile.reco_PCMRA                          = 1; % Create PC-MRA             [ 1:yes, 0:no]
%% % ENCODING PARAMETERS
