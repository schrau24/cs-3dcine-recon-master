function sendmail_from_amc_textfile(mail_recipient, mail_subject, mail_text_file)
...
%
% Example: 
% sendmail_from_amc_textfile('l.m.gottwald@amc.uva.nl', 'Testmail', '/home/testfile.txt')
%
